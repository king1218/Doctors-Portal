...
const Login = () => {
  ...
  <div className="card-body">
   ...
   {errors.password?.type === 'minLength' && <span className="label-text-alt text-red-500">{errors.password.message}</span>}
    ...
    <button  className='text-sm text-accent mb-2'>Forget Password?</button>
    <input className='btn w-full max-w-xs text-white' type="submit" value="Login" />
    <p className='text-sm text-center my-2' href="#">New To Dcotors Portal?<Link to="/register" className='text-secondary'> Create New Account</Link></p>
    </form>
